...
export function DataProtectionPanel() {
  ...
  return (
    ...
    >
      <header>
        <p style={{ margin: 0, fontSize: 12, fontWeight: 700, letterSpacing: 1.3, color: "#b45309", textTransform: "uppercase" }}>
          Trust & Safety
        </p>
        <h2 id="data-protection" style={{ margin: "6px 0 10px 0", fontSize: 22, fontWeight: 800, color: "#92400e" }}>
          Data Protection & Community Safety
        </h2>
        <p style={{ margin: 0, color: "#9a3412" }}>
          Verified signup, AI moderation, GDPR controls. Your activity is safe, and reports reach moderators instantly.
        </p>
      </header>
